...
class CourseMapCourseFetchProcessor extends AbstractCommandProcessor {
    public CourseMapCourseFetchProcessor(ProcessorContext context) {
        super(context);
    }
    ...
    protected MessageResponse processCommand() {
        return RepoBuilder.buildCourseMapRepo(context).fetchCourseMapCourse();
    }
