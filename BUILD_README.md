Building nucleus-handlers-content
==============
...
> java -classpath ./build/libs/nucleus-content-map-0.1-snapshot-fat.jar: -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/resources/nucleus-content-map.json -cluster -instances 4
